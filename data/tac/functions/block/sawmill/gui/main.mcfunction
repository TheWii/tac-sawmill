...
execute store result score #locked_slots_count tac.temp if data storage tac:temp inventory[{Count:1b, tag:{lockedSlot:1b}}]
execute unless score #locked_slots_count tac.temp matches 26 run function tac:block/sawmill/gui/locked_slots
