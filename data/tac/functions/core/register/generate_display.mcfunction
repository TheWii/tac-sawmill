...
data modify entity 0-0-0-0-7 Item set from storage tac:data recipes[-1].display
...
data modify storage tac:data recipes[-1].display.tag.display.Name set from block 1 0 0 Text1
